...
void printAsciiFromVector(const vector<int>& translatedMsg) {
    ...
    for (int i = 0; i < total; i += glyphsPerLine) {
        ...
        //So you keep printing 20 until 764-i becomes less than 20
...
int main(int argc, char** argv) {
    ...
    cout << ">>>>>>>>>>         Please expand your terminal so it can display at least 119 characters on one line         <<<<<<<<<<" << endl << endl;
